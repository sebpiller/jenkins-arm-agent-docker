                                                ...
                                                script
                                                        {
                                                            ...
                                                            if (matcherRelease.matches()) {
                                                                ...
                                                                env.DOCKER_TAG = env.RELEASE_VERSION
                                                ...
                                                script
                                                        {
                                                            ...
                                                            if (env.BUILD_DOCKER == "true") {
                                                                sh 'service docker restart && docker buildx build --platform linux/arm64,linux/arm/v7 --push -t sebpiller/jenkins-agent:latest -t sebpiller/jenkins-agent:${DOCKER_TAG} .'
                                                            } else {
